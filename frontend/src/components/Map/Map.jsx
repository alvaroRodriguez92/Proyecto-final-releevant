...
function DisplayPosition({ map }) {
  const { empresas, setEmpVistas, empVistas, setEmpresas } = useCardContext();
  ...
  useEffect(() => {
    ...
    empresas.map((e)=>{
      if(e.LATITUD < position._northEast.lat && e.LONGITUD < position._northEast.lng &&
      e.LATITUD > position._southWest.lat && e.LONGITUD > position._southWest.lng){
        ev.push(e)
      }
    })
