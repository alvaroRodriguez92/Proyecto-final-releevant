...
const ICONOS = {
    ...
    "LEGAL/ADMINISTRACION": <AccountBalanceOutlinedIcon/>,
    INDUSTRIA: <FactoryOutlinedIcon/>,
    EDUCADION: <MenuBookOutlinedIcon/>,
    DEPORTE: <SportsFootballOutlinedIcon/>,
    TECNOLOGIA: <NightShelterOutlinedIcon/>,
    HOGAR: <GiteOutlinedIcon/>,
    AUTOMOCION: <DevicesOutlinedIcon/>,
    INMOBILIARIA: <DirectionsCarOutlinedIcon/>,
    CULTURA: <HomeWorkOutlinedIcon/>,
    HOSTELERIA: <SchoolOutlinedIcon/>,
