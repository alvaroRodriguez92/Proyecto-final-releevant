    ...
    <>
      <Grid>
        <Grid>
          ...
          <TextField sx={{ backgroundColor: "white", m: 2 }} hiddenLabel id="filled-hidden-label-small" placeholder="Suscríbete a la Newsletter" variant="filled" size="small" />
          <Button variant="contained" size="medium" sx={{ mt: 2, mb: 2, boxShadow: "8px 8px black" }}>
            Suscríbete
          </Button>
        </Grid>
      </Grid>
      <FormGroup sx={{ color: "white", m: 2 }}>
        <FormControlLabel control={<Checkbox sx={{ "& .MuiSvgIcon-root": { fontSize: 28, color: "white" } }} />} label="Acepto política de privacidad" />
      </FormGroup>
